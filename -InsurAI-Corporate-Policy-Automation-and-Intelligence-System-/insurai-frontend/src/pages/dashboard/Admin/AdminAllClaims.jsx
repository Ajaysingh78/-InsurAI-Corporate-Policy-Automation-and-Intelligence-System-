...
const AdminAllClaims = ({ claims = [] }) => {
  ...
  const handleExportData = () => {
    const dataToExport = filteredClaims.map((claim) => ({
      ...
      Status: claim.status,
      "Submitted Date": claim.claimDate
        ...
        {selectedClaims.length > 0 && (
          ...
          >
            <span style={{ fontWeight: "600", color: "#2b0938" }}>
              ...
              {selectedClaims.length !== 1 ? "s" : ""} selected
            </span>
                  ...
                  {currentClaims.map((claim, index) => (
                    <tr
                      ...
                      style={{
                        ...
                        background: selectedClaims.includes(claim.id)
                          ? "#f0f9ff"
                          : "white",
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        border: "2px solid",
                        borderColor:
                          currentPage === pageNum ? "#667eea" : "#e2e8f0",
                        background:
                          currentPage === pageNum
                            ? "linear-gradient(135deg, #667eea 0%, #764ba2 100%)"
                            : "white",
                  ...
                  <div>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <div style={{ fontSize: "15px", color: "#1e293b" }}>
                          {new Date(viewClaim.claimDate).toLocaleDateString(
                            "en-US",
                            {
                              weekday: "long",
                              year: "numeric",
