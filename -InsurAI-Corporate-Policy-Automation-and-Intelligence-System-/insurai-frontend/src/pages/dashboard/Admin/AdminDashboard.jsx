...
const theme = {
  ...
  gradientLight:
    "linear-gradient(135deg, rgba(43,9,56,0.1) 0%, rgba(139,0,134,0.1) 100%)",
};
...
export default function AdminDashboard() {
    ...
    try {
      ...
      const mappedClaims = claimsData.map((claim) => {
        const employee = employees.find(
          (e) => e.id === (claim.employeeId || claim.employee_id),
        );
        const hr = hrs.find(
          (h) => h.id === (claim.assignedHrId || claim.assigned_hr_id),
        );
  ...
  const stats = {
    ...
    activeUsers: users.filter((u) => u.status?.toLowerCase() === "active")
      .length,
              ...
              <div className="card-body">
                ...
                <div className="progress" style={{ height: "6px" }}>
                  <motion.div
                    ...
                    initial={{ width: 0 }}
                    animate={{
                      width: `${(stats.activeUsers / Math.max(stats.totalUsers, 1)) * 100}%`,
                    }}
              ...
              <div className="card-body">
                ...
                <div className="progress" style={{ height: "6px" }}>
                  <motion.div
                    ...
                    initial={{ width: 0 }}
                    animate={{
                      width: `${(stats.resolvedClaims / Math.max(stats.totalClaims, 1)) * 100}%`,
                    }}
            ...
            >
              <div className="card-body">
                <div className="d-flex justify-content-between align-items-start mb-3">
                  ...
                  >
                    <i
                      className="bi bi-exclamation-triangle fs-3"
                      style={{ color: theme.danger }}
                    ></i>
                  </div>
                </div>
                  ...
                  >
                    <div className="activity-icon me-3">
                      <div
                        ...
                        style={{
                          backgroundColor: activity.status.includes("pending")
                            ? "#fef3c7"
                            : "#d1fae5",
                          color: activity.status.includes("pending")
                            ? theme.warning
                            : theme.success,
                        }}
                      >
        ...
        >
          <div className="text-center">
            <div
              ...
              style={{ color: theme.secondary, width: "3rem", height: "3rem" }}
              role="status"
            >
          ...
          <div className="row align-items-center py-3 px-2">
            ...
            <div className="col-md-4 d-none d-md-block">
              <div className="search-wrapper position-relative">
                <i
                  className="bi bi-search position-absolute text-white-50"
                  style={{
                    left: "15px",
                    top: "50%",
