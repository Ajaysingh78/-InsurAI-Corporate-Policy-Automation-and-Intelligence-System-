...
export default function HRClaims({
  ...
  const claimsStats = useMemo(() => {
    ...
    const approved = pendingClaims.filter(
      (c) => c.status === "Approved",
    ).length;
    const rejected = pendingClaims.filter(
      (c) => c.status === "Rejected",
    ).length;
    const totalAmount = pendingClaims.reduce(
          ...
          <div className="d-flex justify-content-between align-items-center mb-3">
            <div>
              ...
              <p className="text-muted mb-0">
                Review and manage employee insurance claims
              </p>
            </div>
          ...
          <div className="card bg-info bg-opacity-10 border-0 shadow-sm">
            <div className="card-body text-center">
              ...
              <h5 className="text-info mb-1">
                {formatCurrency(claimsStats.totalAmount)}
              </h5>
          ...
          <div className="card bg-secondary bg-opacity-10 border-0 shadow-sm">
            <div className="card-body text-center">
              ...
              <h5 className="text-secondary mb-1">
                {formatCurrency(claimsStats.pendingAmount)}
              </h5>
                          ...
                          {claim.status === "Pending" && claim.canModify && (
                            <>
                              <button
                                ...
                                onClick={() => {
                                  const latestRemarks =
                                    mappedClaims.find((c) => c.id === claim.id)
                                      ?.remarks || "";
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="mb-3">
                      ...
                      <small className="text-muted">
                        ID: {viewingClaim.employeeIdDisplay}
                      </small>
                    </div>
                    <div className="mb-3">
                      <label className="fw-semibold text-muted">
